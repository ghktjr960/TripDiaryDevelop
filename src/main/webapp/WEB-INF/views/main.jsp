...
<body>
	...
	<div class="container">
		...
		<c:if test="${empty tagSearch && empty tagNoSearchResult}">
		...
		<c:if test="${tagSearch eq null && tagNoSearchResult eq 'tagNoSearchResult'}">
			<div class="container">
				<div class="container">
					<img alt="" src="resources/img/error.png" style="width: 30%;">
				</div>
		...
		<c:if test="${!empty tagSearch && tagSearch ne null}">
			<div class="diary-mid row mt-5 mb-5">
				<c:forEach items="${mainBoardList}" var="mainBoardList">
